...
import Graphics.Phaser (PhaserContainer, PhaserScene, 
        addContainer, addGraphicsToContainer, addImage, addImageToContainer, 
        addTextToContainer, solidColorRect, text)
import UI.Elements (Element(..))


addToContainer :: forall t11 t2 t5 t6.
  Applicative t6 => Bind t6 => Maybe t5
                               -> t2
                                  -> ({ container :: t5
                                      , element :: t2
                                      }
